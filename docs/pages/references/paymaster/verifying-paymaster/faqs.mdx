...
No. Either add balance on the [Pimlico dashboard](https://dashboard.pimlico.io), or add a credit card and pay for your usage at the end of each month.

Adding a card unlocks an overdraft based on your account type:

- **Companies** (work email): $1,000
- **Individuals** (personal email such as Gmail or Outlook): $10

:::info
If you would like to add to your balance using crypto, or you would like an overdraft limit higher than your default, please [contact us](https://t.me/pimlicoHQ).
:::
